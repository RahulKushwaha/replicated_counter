...
class SequencerServer final: public SequencerService::Service {
 public:
  ...
  grpc::Status append(::grpc::ServerContext *context,
                      const ::rk::projects::durable_log::server::SequencerAppendRequest *request,
                      ::rk::projects::durable_log::server::LogIdResponse *response) override;
  grpc::Status latestAppendPosition(::grpc::ServerContext *context,
                                    const ::google::protobuf::Empty *request,
                                    ::rk::projects::durable_log::server::LogIdResponse *response) override;
  grpc::Status isAlive(::grpc::ServerContext *context,
                       const ::google::protobuf::Empty *request,
