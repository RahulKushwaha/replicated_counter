...
const uint32_t TableStruct_MetadataConfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rk::projects::durable_log::MetadataConfig, _impl_.versionid_),
  PROTOBUF_FIELD_OFFSET(::rk::projects::durable_log::MetadataConfig, _impl_.previousversionid_),
  PROTOBUF_FIELD_OFFSET(::rk::projects::durable_log::MetadataConfig, _impl_.startindex_),
  PROTOBUF_FIELD_OFFSET(::rk::projects::durable_log::MetadataConfig, _impl_.endindex_),
  PROTOBUF_FIELD_OFFSET(::rk::projects::durable_log::MetadataConfig, _impl_.previousversionendindex_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::rk::projects::durable_log::MetadataConfig)},
};
...
const char descriptor_table_protodef_MetadataConfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "tIndex\030\003 \001(\003\022\020\n\010endIndex\030\004 \001(\003\022\037\n\027previo"
  "usVersionEndIndex\030\005 \001(\003b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_MetadataConfig_2eproto = {
    false, false, 191, descriptor_table_protodef_MetadataConfig_2eproto,
