...
PROTOBUF_NAMESPACE_OPEN
template<> ::rk::project::counter::CounterLogEntry* Arena::CreateMaybeMessage<::rk::project::counter::CounterLogEntry>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rk {
namespace project {
namespace counter {
...
class CounterLogEntry final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rk.project.counter.CounterLogEntry) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "rk.project.counter.CounterLogEntry";
  }
  protected:
  ...
  ::rk::project::counter::CounterLogEntry_CommandType commandtype() const;
  void set_commandtype(::rk::project::counter::CounterLogEntry_CommandType value);
  private:
  ::rk::project::counter::CounterLogEntry_CommandType _internal_commandtype() const;
  void _internal_set_commandtype(::rk::project::counter::CounterLogEntry_CommandType value);
  public:

  // @@protoc_insertion_point(class_scope:rk.project.counter.CounterLogEntry)
 private:
  class _Internal;
...
inline int64_t CounterLogEntry::val() const {
  // @@protoc_insertion_point(field_get:rk.project.counter.CounterLogEntry.val)
...
inline void CounterLogEntry::set_val(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:rk.project.counter.CounterLogEntry.val)
}
...
inline ::rk::project::counter::CounterLogEntry_CommandType CounterLogEntry::_internal_commandtype() const {
  return static_cast< ::rk::project::counter::CounterLogEntry_CommandType >(_impl_.commandtype_);
}
inline ::rk::project::counter::CounterLogEntry_CommandType CounterLogEntry::commandtype() const {
  // @@protoc_insertion_point(field_get:rk.project.counter.CounterLogEntry.commandType)
  return _internal_commandtype();
}
inline void CounterLogEntry::_internal_set_commandtype(::rk::project::counter::CounterLogEntry_CommandType value) {
  
  _impl_.commandtype_ = value;
}
inline void CounterLogEntry::set_commandtype(::rk::project::counter::CounterLogEntry_CommandType value) {
  _internal_set_commandtype(value);
  // @@protoc_insertion_point(field_set:rk.project.counter.CounterLogEntry.commandType)
}
...
inline const std::string& CounterLogEntry::description() const {
  // @@protoc_insertion_point(field_get:rk.project.counter.CounterLogEntry.description)
...
void CounterLogEntry::set_description(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.description_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rk.project.counter.CounterLogEntry.description)
}
inline std::string* CounterLogEntry::mutable_description() {
  std::string* _s = _internal_mutable_description();
  // @@protoc_insertion_point(field_mutable:rk.project.counter.CounterLogEntry.description)
  return _s;
}
...
inline std::string* CounterLogEntry::release_description() {
  // @@protoc_insertion_point(field_release:rk.project.counter.CounterLogEntry.description)
...
inline void CounterLogEntry::set_allocated_description(std::string* description) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rk.project.counter.CounterLogEntry.description)
}
...
template <> struct is_proto_enum< ::rk::project::counter::CounterLogEntry_CommandType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::rk::project::counter::CounterLogEntry_CommandType>() {
  return ::rk::project::counter::CounterLogEntry_CommandType_descriptor();
}
