...
const uint32_t TableStruct_CounterEntry_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rk::projects::counter_app::CounterLogEntry, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::rk::projects::counter_app::CounterLogEntry, _impl_.val_),
  PROTOBUF_FIELD_OFFSET(::rk::projects::counter_app::CounterLogEntry, _impl_.commandtype_),
  PROTOBUF_FIELD_OFFSET(::rk::projects::counter_app::CounterLogEntry, _impl_.description_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::rk::projects::counter_app::CounterLogEntry)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::rk::projects::counter_app::_CounterLogEntry_default_instance_._instance,
};

const char descriptor_table_protodef_CounterEntry_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022CounterEntry.proto\022\027rk.projects.counte"
  "r_app\"\241\001\n\017CounterLogEntry\022\013\n\003val\030\001 \001(\003\022I"
  "\n\013commandType\030\002 \001(\01624.rk.projects.counte"
  "r_app.CounterLogEntry.CommandType\022\023\n\013des"
  "cription\030\003 \001(\t\"!\n\013CommandType\022\010\n\004INCR\020\000\022"
  "\010\n\004DECR\020\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_CounterEntry_2eproto = {
    false, false, 217, descriptor_table_protodef_CounterEntry_2eproto,
    "CounterEntry.proto",
...
CounterLogEntry::CounterLogEntry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:rk.projects.counter_app.CounterLogEntry)
}
CounterLogEntry::CounterLogEntry(const CounterLogEntry& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rk.projects.counter_app.CounterLogEntry)
}
...
CounterLogEntry::~CounterLogEntry() {
  // @@protoc_insertion_point(destructor:rk.projects.counter_app.CounterLogEntry)
...
// @@protoc_insertion_point(message_clear_start:rk.projects.counter_app.CounterLogEntry)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_commandtype(static_cast<::rk::projects::counter_app::CounterLogEntry_CommandType>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "rk.projects.counter_app.CounterLogEntry.description"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* CounterLogEntry::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:rk.projects.counter_app.CounterLogEntry)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_description().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "rk.projects.counter_app.CounterLogEntry.description");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rk.projects.counter_app.CounterLogEntry)
  return target;
}

size_t CounterLogEntry::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rk.projects.counter_app.CounterLogEntry)
  size_t total_size = 0;
...
void CounterLogEntry::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:rk.projects.counter_app.CounterLogEntry)
...
// @@protoc_insertion_point(class_specific_copy_from_start:rk.projects.counter_app.CounterLogEntry)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::rk::projects::counter_app::CounterLogEntry*
Arena::CreateMaybeMessage< ::rk::projects::counter_app::CounterLogEntry >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rk::projects::counter_app::CounterLogEntry >(arena);
}
